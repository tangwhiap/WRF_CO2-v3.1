...
start=$1                     # Start datetime "YYYY-MM-DD_hh:mm:ss"

#end="2020-01-03_00:00:00"   # End datetime "YYYY-MM-DD_hh:mm:ss"
end=$2                       # End datetime "YYYY-MM-DD_hh:mm:ss"

dom=$3                       # WRF domain num, select from 1/2/3

dtMin=$4                    # Time interval in minute, better to be consist with it of wrfout. 
